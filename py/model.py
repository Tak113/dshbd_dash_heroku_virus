## to fit data and forecast
## to be simplified, just use parametric curve fitting approach, optimizing the parameters of a logistic function for each country time series
