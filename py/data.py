#data class which will be executed when the app starts
#Everytime time the page of the browser where the app runs is loaded, the backend gets fresh data directly from the source
